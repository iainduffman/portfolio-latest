    ...
    <>
      ...
      <progress max="100" value="0"></progress>
        ...
        <div className="w-full h-full flex justify-center items-center realizzazioni">
          ...
          Flavours that tell a uniquely charming story of India __
          </p>
            ...
            <section ref={(el) => (textRefs.current[1] = el)} className="default double mt-16 mb-16"><StaticImage src="../images/DSC02868.jpg" alt="" /></section>
            ...
            <section className="default mt-16 mb-16"><StaticImage src="../images/DSC02875.jpg" /></section>
        ...
        <section className="default double mt-16 mb-16"><StaticImage src="../images/DSC02589.jpg" alt="" /></section>

        <section className="default double mt-16 mb-16"><StaticImage src="../images/DSC02571.jpg" alt="" /></section>
