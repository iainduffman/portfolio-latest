...
const About = ({ transitionStatus }) => {
  ...
  const textfly = (textRefs, direction) => {
    ...
    mySplitText = new SplitText("#quote-seven", {type:"words,chars"}), 
    chars = mySplitText.chars; //an array of all the divs that wrap each character

gsap.set("#quote-seven", {perspective: 400});
...
tl.from(chars, {duration: 0.8, y:180, transformOrigin:"0% 50% -50",  ease:"out", stagger: 0.01}, "+=0");
  ...
  useEffect(() => {
    if (transitionStatus === 'exiting') {
      ...
      gsap.set("#quote-seven", {opacity: 1});
      textfly(textRefs.current, -1);
    }
  }, [transitionStatus]);
  return (
    <>
      ...
      <progress max="100" value="0"></progress>
        ...
        <div className="w-full h-full flex justify-center items-center realizzazioni">
          ...
          <p id="quote-seven" className="list-none text-6xl md:text-6xl lg:text-8xl font-thin relative overflow-hidden uppercase transform phrase">
          Telling the story of home in a place of __ambience.
            ...
            <p id="quote-seven" className="text-white list-none text-6xl md:text-6xl lg:text-8xl font-thin relative overflow-hidden uppercase transform phrase">
